...
public class EgovStringUtil {
	 ...
	 */
	public static String[] split(String source, String separator, int length) throws NullPointerException {
		String[] returnVal = new String[length];
		int cnt = 0;
		int index0 = 0;
		int index = source.indexOf(separator);
		while (index >= 0 && cnt < (length - 1)) {
			returnVal[cnt] = source.substring(index0, index);
			index0 = index + 1;
			index = source.indexOf(separator, index + 1);
			cnt++;
	...
	public static String getRandomStr(char startChr, char endChr) {
		...
		Integer startInt = Integer.valueOf(startChr);
		Integer endInt = Integer.valueOf(endChr);
	...
	public static String getEncdDcd(String srcString, String srcCharsetNm, String cnvrCharsetNm) {
		...
		try {
			return new String(srcString.getBytes(srcCharsetNm), cnvrCharsetNm);
	...
	public static String getHtmlStrCnvr(String srcString) {
		...
		return StringEscapeUtils.unescapeHtml(srcString);
	}
